    ...
    <>
      ...
      <main className="flex h-full w-full bg-neutral-900 pr-8">
        ...
        <section className="h-full w-11/12 py-6">
          <div className="flex h-full flex-col rounded-xl bg-zinc-800 shadow-2xl">
            ...
            <div className="flex h-full w-full flex-wrap items-center justify-evenly gap-4 overflow-y-auto px-8 py-2">
